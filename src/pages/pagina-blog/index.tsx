...
export default function Pagina_Blog () {
            ...
            <div className='p-2   flex items-start justify-between'>
                <div className='flex-1 p-14'>
                    ...
                    <div className='px-10  flex gap-x-10'>
                        <Link href='/'><Image className='cursor-pointer'  width="20" height="20" src='/assets/images/sobre/facebook.svg' /></Link>
                        <Link href='/'><Image className='cursor-pointer'  width="20" height="20" src='/assets/images/sobre/twiter.svg' /></Link>
                        <Link href='/'><Image className='cursor-pointer'  width="20" height="20" src='/assets/images/sobre/instagran.svg' /></Link>
                    </div>
                </div>
